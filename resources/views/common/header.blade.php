...
<body class="font-sans antialiased bg-[#0e0c0a] flex flex-col h-full">
    <div class="bg-[#0e0c0a] px-5 flex z-50 my-4">
        ...
        <div class="cursor-pointer text-white mt-4">
            <nav>
                ...
                <div onclick="exitNav()" id="sideBar" class="fixed top-0 right-0 bg-transparent w-0 h-full overflow-x-hidden duration-500 z-10">
                    <!--navigation menu box-->
                    <div id="sideNav" onclick="event.stopPropagation()" class="fixed top-0 right-0 bg-[#171614] overflow-x-hidden duration-500 font-bold flex justify-center items-start h-full w-0 pt-24">
