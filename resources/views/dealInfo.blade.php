    ...
    <div class="flex flex-col gap-7">
        <div class="flex flex-col rounded-xl text-center overflow-hidden group relative dealCardWrapper">
            <div class="card-front bg-secondary">
                <div class="py-12 text-white">
                    ...
                    <div class="text-xl mb-5">Problemen met scannen?</div>
                ...
                <div class="bg-white p-6 text-left">
                    <h2 class="font-normal text-2xl mb-1">Hoe en waar te scannen</h2>
                    <p class="text-sm mb-2">Houd jouw telefoon op 7-10 cm afstand van de scanner. Wanneer de code is gescand, hoor je een piep en verschijnt een bevestigingsbericht.</p>
                    <h2 class="font-normal text-2xl mb-1">Als scannen niet werkt</h2>
                    <p class="text-sm">Als het scannen niet werkt, geef dan de cijfercode mondelings door aan de medewerker.</p>
        ...
        <div class="flex flex-col rounded-xl text-center overflow-hidden group relative dealCardWrapper">
            <div class="bg-secondary">
                ...
                <div class="bg-white p-6 text-left">
                    <h2 class="font-normal text-2xl mb-1">Hoe werken punten</h2>
                    <p class="text-sm">
