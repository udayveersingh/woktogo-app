...
<path style="display: inline;" d="M248.644,123.476c-5.45-29.71,8.598-60.285,25.516-80.89
    ...
    <form>
        <div class="flex flex-col gap-2 mb-4">
            ...
            <input type="email" autocomplete="off" placeholder="E-mail of gebruikersnaam" class="bg-white rounded-xl px-5 py-4 text-sm"  />
        </div>
        <div class="flex flex-col gap-2 mb-4">
    ...
    <div class="text-center mt-7">
        ...
        <div class="mt-8">Geen account? <a class="underline text-white" href="#">Maak een account aan</a></div>
    </div>
