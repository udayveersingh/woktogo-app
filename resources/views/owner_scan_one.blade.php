...
<form action="{{route('owner_scan_two')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="flex flex-col items-center pt-40 min-h-full bg-yellow-500 transition-all duration-300" id="overlay-container">
        ...
        <input type="text" class="focus:z-20 border border-gray-300 rounded-xl p-3 w-3/4 max-w-sm text-center focus:outline-none focus:border-transparent uppercase caret-red" name="user_code" onfocus="addOverlay()" onblur="removeOverlay()" />
