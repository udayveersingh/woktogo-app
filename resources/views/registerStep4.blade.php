...
<div class="px-5 py-12 max-w-[500px] mx-auto">
    ...
    <div class="flex flex-col gap-2 mb-4">
            <label class="flex gap-2"><input type="checkbox"/> Stuur me nieuws en deals van Wok to Go Rotterdam</label>
        </div>

        <div class="flex flex-col gap-2 mb-4">
            <label class="flex gap-2"><input type="checkbox"/> Akkoord algemene voorwaarden</label>
        </div>
